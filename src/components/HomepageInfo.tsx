...
const HomepageInfo = (props: any) => {
    ...
    if (props.colors === 'color') {
        colors.bgColors = "w-screen h-screen flex flex-col-reverse md:flex-row justify-start items-start bg-white p-16 gap-10";
        ...
        colors.bgColors = "w-screen h-screen flex flex-col-reverse md:flex-row-reverse justify-end items-start bg-webGreen p-16 gap-10";
    ...
    return (
            <div className={colors.bgColors}>
                ...
                <div className="flex flex-col gap-12 items-start h-3/5">
                    <div>
