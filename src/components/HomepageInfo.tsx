...
const HomepageInfo = (props: any) => {
  ...
  if (props.colors === "color") {
    colors.bgColors =
      "w-screen flex flex-col-reverse md:flex-row justify-center md:justify-start items-center bg-white p-16 md:px-48 md:py-16 gap-10";
    ...
    colors.bgColors =
      "w-screen flex flex-col-reverse md:flex-row-reverse justify-center md:justify-end items-center bg-webGreen p-16 md:px-48 md:py-16 gap-10";
  ...
  return (
    <div className={colors.bgColors}>
      <img
        src={elainaImage}
        className="md:w-2/3 sm:h-3/5 rounded-md shadow-md object-cover"
      ...
      <div className="flex flex-col gap-12 items-start h-auto md:h-3/5">
        <div>
          ...
          <p className={`${colors.textColors} max-w-prose`}>{props.description}</p>
        </div>
        <NavButton
          path={props.route}
