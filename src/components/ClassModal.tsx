...
const ClassModal = (props: any) => {
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center z-10 backdrop-blur-sm">
      <div className="bg-webGreen w-screen h-screen sm:h-auto sm:w-3/5 rounded-md p-8 text-white flex flex-col shadow-lg shadow-black animate-inOut">
        ...
        <div className="flex flex-row gap-5">
          ...
          <p>How Often Its Taught: {props.taught}</p>
        </div>
        <br></br>
        <button
