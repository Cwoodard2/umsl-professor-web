...
const ClassModal = (props: any) => {
  ...
  return (
    <div className="fixed top-[100px] bottom-0 left-0 right-0 flex justify-center items-center z-10 backdrop-blur-sm">
      <div className="bg-webGreen w-screen h-screen sm:h-auto sm:w-3/5 rounded-md p-8 text-white flex flex-col shadow-lg shadow-webGreen animate-inOut">
        ...
        <div className="flex flex-col gap-5">
          {props.mode && <p><strong>Modality:</strong> {props.mode}</p>}
          {props.nextOffered && <p><strong>Next Offered:</strong> {props.nextOffered}</p>}
          {props.taught && <p><strong>How Often It's Taught:</strong> {props.taught}</p>}
        </div>
        <br></br>
        <button
