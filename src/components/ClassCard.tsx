...
const ClassCard = (props: any) => {
    ...
    return (
        <div className="flex flex-col md:w-2/5 h-96 bg-webGreen rounded-md hover:shadow-lg hover:shadow-black transition-all">
            ...
            <button onClick={changeModalState} className="border-white border-4 p-1 w-3/5 rounded-md text-white hover:text-webGreen hover:bg-white transition-all">Learn more</button>
        </div>
    );
};
